...
%We also wanted to study the influence of being in a group or alone when interacting with the robot.
%At the difference from the group configuration, in the group configuration, other children were witnessing the interaction with the child.
...
%todo see if add significance here 
